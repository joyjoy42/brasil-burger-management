...
class Burger
{
    ...
    #[ORM\OneToMany(mappedBy: 'burger', targetEntity: MenuItem::class, cascade: ['persist', 'remove'])]
    private Collection $menuItems;

    #[ORM\OneToMany(mappedBy: 'burger', targetEntity: CommandeItem::class, cascade: ['persist', 'remove'])]
    ...
    public function removeMenuItem(MenuItem $menuItem): static
    {
        if ($this->menuItems->removeElement($menuItem)) {
            ...
            if ($menuItem->getBurger() === $this) {
                $menuItem->setBurger(null);
            }
        }
